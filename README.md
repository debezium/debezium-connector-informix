...
[![Build Status](https://img.shields.io/github/actions/workflow/status/debezium/debezium-connector-informix/maven.yml?branch=3.1&logo=github&label=Maven%20CI)](https://github.com/debezium/debezium-connector-informix/actions/workflows/maven.yml?query=branch:3.1)
